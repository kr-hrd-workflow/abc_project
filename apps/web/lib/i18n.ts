...
export const copy = {
  ko: {
    ...
    simulationViewport: "Unity 가상 CCTV + SUMO 검증 뷰",
    simulationViewportSub: "Unity presentation fallback, SUMO validation metrics",
    signalState: "신호 상태",
    vehicle: "차량",
    pedestrian: "보행자",
    emergency: "긴급차량",
  ...
  en: {
    ...
    simulationViewport: "Unity virtual CCTV + SUMO validation view",
    simulationViewportSub: "Unity presentation fallback, SUMO validation metrics",
