...
export type RealSampleIntakePackage = {
  ...
  prepareNationalLiveInputCommand: "npm run real-sample:prepare-national-live-input -- <detector-output.json> <camera-calibration.json> <national-tl-drct-info-response.json> <signal-snapshot.json> <live-input-envelope.json> <crsrdId> <nextPhase> <controllerMode> <manualOverride>";
  noPersistence: true;
