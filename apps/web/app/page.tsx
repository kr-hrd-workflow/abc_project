...
const landingCopy = {
  en: {
    ...
    hero:
      "Simulation workspace for traffic teams to sense pressure, compare timing, and preview an Hosted simulation stream digital-twin viewport before a field change.",
    ...
    assembly: [
      ...
      ["Dashboard opened", "The operator lands in the Hosted simulation stream + SUMO validation surface with the boundary intact."],
    ],
    ...
    ctaCopy:
      "Move from the cinematic landing page into the launch-ready dashboard and inspect the Hosted simulation stream player plus SUMO validation metrics.",
  ...
  ko: {
    ...
    hero:
      "교통 운영팀이 현장 변경 전에 압력을 감지하고, 신호 타이밍을 비교하고, Hosted simulation stream 디지털 트윈 화면을 미리 보는 시뮬레이션 작업 공간입니다.",
    ...
    assembly: [
      ...
      ["대시보드 열기", "운영자는 경계를 유지한 채 Hosted simulation stream + SUMO 검증 화면으로 이동합니다."],
    ],
    ...
    ctaCopy:
      "시네마틱 랜딩에서 출시 가능한 대시보드로 이동해 Hosted simulation stream 플레이어와 SUMO 검증 지표를 함께 확인하세요.",
